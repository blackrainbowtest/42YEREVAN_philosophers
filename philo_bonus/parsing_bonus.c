...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/19 13:03:02 by root              #+#    #+#             */
/*   Updated: 2025/07/19 15:10:41 by root             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const char	*valid_input(const char *str)
{
	...
	if (*str == '+')
		...
		error_exit("You can't handle negative numbers! Use positive ones.");//TODO
	if (*str == '\0')
		error_exit("Input is empty or only spaces.");//TODO
	if (!is_digit(*str))
		error_exit("Incorrect input! Use only digits.");//TODO
	number = str;
	while (is_digit(*str))
	{
		++len;
